...
class RegisterDialog(QDialog):
    def __init__(self, parent=None):
        ...
        title = QLabel("✨ Join Chemical Visualizer")
    ...
    def register_user(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                self.created_username = user
                self.created_password = pwd
                self.accept()
            else:
                ...
                try:
                    ...
                    if 'username' in errors:
                        error_msg = f"Username error: {errors['username'][0]}"
                except:
                    pass
...
class LoginDialog(QDialog):
    ...
    def open_register(self):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            self.username.setText(dialog.created_username)
            self.password.setText(dialog.created_password)
            self.check_login()
